...
url_source = ""
url_custom = [{name = "Corrigendum", url = "papers/wu2023replacement_corrigendum.pdf"},{name = "Link", url = "https://www.sciencedirect.com/science/article/pii/S0010027723002809"}, {name = "Github", url = "https://github.com/cicl-stanford/responsibility_replacement"}]
math = true
highlight = true
[header]
